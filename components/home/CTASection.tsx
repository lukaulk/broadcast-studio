  ...
  return (
    <section className="py-20 bg-gradient-to-b relative from-cyan-300/10 to-blue-900/10 border-t border-gray-800">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-[var(--muted-foreground)] mb-8  z-10 relative">
          Join thousands of students and professionals already using Broadcast Studio
        </p>
        <Link href="/studio" >
          <button type='button' className="group  z-10 bg-gradient-to-r cursor-pointer from-cyan-400 to-blue-500 text-[var(--primary-foreground)] px-10 py-5 rounded-full font-bold text-xl hover:scale-105 transition-all duration-300 shadow-2xl shadow-cyan-400/25">
