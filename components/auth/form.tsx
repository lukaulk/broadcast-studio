...
export function AuthForm({ mode = "login", onSubmit, onGoogleLogin, onGithubLogin }: AuthFormProps) {
  ...
  return (
    <Card className="w-full max-w-md radio-canada bg-zinc-900 border-zinc-800">
      ...
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full" disabled={isLoading}>
            {isLoading ? "Loading..." : formMode === "login" ? "Sign In" : "Sign Up"}
          </Button>
        </form>
      </CardContent>
      <CardFooter>
