...
export default function CTASection() {
    ...
    <section className="py-20 bg-gradient-to-b from-cyan-300/10 to-blue-900/10 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <button type='button' className="group bg-gradient-to-r cursor-pointer from-cyan-400 to-blue-500 text-black px-10 py-5 rounded-full font-bold text-xl hover:scale-105 transition-all duration-300 shadow-2xl shadow-cyan-400/25">
