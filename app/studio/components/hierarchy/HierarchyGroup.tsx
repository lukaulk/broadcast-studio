...
export function HierarchyGroup({
    ...
    return (
        <div className="select-none flex items-center gap-2">
            {/* Group Header */}
            <div className="flex-col flex hover:bg-[var(--bsui-gray-2)] transition-colors w-full border-b shadow-xl  shadow-black/10">
                <div className="flex w-full items-center py-2">
                    {/* Expand Group Button */}
                    <button
                        onClick={() => onToggleExpand(group.id)}
                        className="p-2 hover:bg-[var(--bsui-gray-1)] rounded transition-colors ml-2"
                    >
                        {group.expanded ? (
                            <svg
                    ...
                    <span className="text-sm text-[var(--bsui-border)]">
                    ...
                    <button
                        ...
                        className="p-2 hover:bg-[var(--bsui-gray-1)] rounded transition-colors ml-1 mr-2 text-[var( --bsui-border)] hover:text-[var(--bsui-gray-0)] opacity-100"
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button
                                variant="ghost"
                                size="sm"
                                className="rounded-none h-6 w-8 mr-2 p-2 text-[var(--bsui-gray-1)] group-hover:opacity-100 data-[state=open]:opacity-100"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                ...
                <div className="flex w-full">
                    ...
                    {
                        group.expanded && (
                            <div className="ml-4 mt-1 space-y-1 flex flex-col w-full mb-3">
