...
export default function Component( { name, type, icon, description }: ComponentProps ) {
  return (
    <div className="flex space-x-4 overflow-x-auto py-2 px-4 h-full items-center hover:scale-105 transition-all cursor-grab active:opacity-40 active:border active:border-blue-500" title={description}>
