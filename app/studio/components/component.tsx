    ...
    >
      {icon && (
        ...
        <Image
          ...
          fill
          sizes="160px"
          className="object-contain scale-90 transition-all duration-500 ease-in-out group-hover:scale-110 drop-shadow-black/10 drop-shadow-2xl pointer-events-none"
        />
      )}
